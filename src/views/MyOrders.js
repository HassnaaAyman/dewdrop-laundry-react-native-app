...
import { base_url, my_orders, height_30, washing_machine } from '../config/Constants';
              ...
              <ListItem onPress={() => this.myorders_details(row)} >
                ...
                <Col style={{ width: '50%' }} >
                  <View style={{ alignItems: 'flex-start' }}>
                    ...
                    <View style={{ margin: 1 }} />
                    <Text style={{ fontSize: 10 }} > {Moment(row.created_at).subtract("03:29:00").format('DD MMM-YYYY hh:mm')}
                    </Text>
